 ...
 * @author FRANCO
 */
public class VistaDeTodo extends javax.swing.JFrame {

    /**
     * Creates new form VistaDeTodo
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaDeTodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
